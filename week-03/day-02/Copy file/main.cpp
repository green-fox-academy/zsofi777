...
// Write a function that reads all lines of a file and writes the read lines to
// an other file (a.k.a copies the file) It should take the filenames as
// parameters It should return a boolean that shows if the copy was successful
