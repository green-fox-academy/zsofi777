...
void Mentor::setLevel(Level level) { _level = level; }
...
void Mentor::introduce() {
  ...
  // <<  translateGender(getGender()) << " " << translateLevel(getLevel()) << "
  // level mentor." << std::endl;
  Person::introduce();
  std::cout << " " << translateLevel(getLevel()) << " level mentor."
            << std::endl;
}
