...
std::string Sponsor::getCompany() const { return _company; }

void Sponsor::setCompany(std::string company) { _company = company; }

int Sponsor::getHiredStudents() const { return _hiredStudents; }
...
void Sponsor::introduce() {
  std::cout << "Hi, I'm " << getName() << ", a " << getAge() << " year old "
            << translateGender(getGender()) << " who represents "
