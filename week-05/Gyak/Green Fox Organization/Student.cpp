...
void Student::introduce() {
  std::cout << "Hi, I'm " << getName() << ", a " << getAge() << " year old " <<  translateGender(getGender()) << " from " << getPreviousOrganization() << " who skipped " << getSkippedDays() << " days from the course already." << std::endl;
}
